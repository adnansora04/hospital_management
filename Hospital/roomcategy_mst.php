      ...
      <div class="container-fluid">
          ...
          <div class="col-md-9">
            ...
            <div class="card">
              <div class="card-header" style="background-color:#007cbc;color:white">
				  <h3 class="card-title"><b>ROOM CATEGORY MASTER</b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="roomcategy_mst_input.php">
				  <?php
				
		$query = mysqli_query($con,"SELECT MAX(cast(code as decimal)) as code1 FROM roomcatgry_mst");
		...
		$currentTime = date( 'Y-m-d', time ());
			...
			if(isset($_GET['edit'])){
					...
					//echo $code;
					$update= true;
					$qry="SELECT * FROM `roomcatgry_mst` WHERE `code` = '$code'";
					//echo $qry;
			 ...
			 <div class="card-body">
					<div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                               <input type="text" name="categy" id="categy" class="form-control" value="<?php if(isset($_GET['edit'])){echo $categy;} ?>">
                                                </div>
                                            </div>
				 						...
				 						<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                   <input type="text" name="terrif" id="terrif" class="form-control" value="<?php if(isset($_GET['edit'])){echo $terrif;} ?>">
                                                </div>
                                            </div>
			 ...
			 <!-----footer----->
                  ...
                  <button type="submit" name="save" value="Save" class="btn btn-success float-right" style="margin-left:6px">Save</button>
									<?php } ?>
                  <a href="roomcategy_mst_report.php"><button type="button" class="btn btn-danger float-right">Back</button></a>
                </div>
