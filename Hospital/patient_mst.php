        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item" > Patient Master</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
          ...
          <div class="col-md-9">
            ...
            <div class="card">
              <div class="card-header" style="background-color:#007cbc;color:white">
				  <h3 class="card-title"><b>PATIENT MASTER</b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="patient_mst_input.php">
				  <?php
				
		$query = mysqli_query($con,"SELECT MAX(cast(code as decimal)) as code1 FROM patiant_mst");
		...
		$currentTime = date( 'Y-m-d', time ());
			...
			if(isset($_GET['edit'])){
					...
					//echo $code;
					$update= true;
					$qry="SELECT * FROM `patiant_mst` WHERE `code` = '$code'";
					//echo $qry;
			 ...
			 <div class="card-body">
					<div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select  id="pname" name="pname" class="select2" style="width:100%" required>
														<?php if(isset($_GET['edit'])){ ?> <option><?php echo $pname; ?></option> <?php } ?>
														<option value="">~~SELECT~~</option>
														<?php $q1=mysqli_query($con,"select distinct pname from patiant_mst order by pname");
				 						...
				 						<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                   <input type="text" name="city" id="city" class="form-control" value="<?php if(isset($_GET['edit'])){echo $city;} ?>">
                                                </div>
                                            </div>
			 ...
			 <!-----footer----->
                  ...
                  <button type="submit" name="save" value="Save" class="btn btn-success float-right" style="margin-left:6px">Save</button>
									<?php } ?>
                  <a href="patient_mst_report.php"><button type="button" class="btn btn-danger float-right">Back</button></a>
                </div>
