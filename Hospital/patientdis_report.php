  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Patient Discharge Search</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
				<li class="breadcrumb-item"><a href="index.php" style="color:#007cbc">Home</a></li>
              <li class="breadcrumb-item" >Patient Discharge Search</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
		...
		<div class="col-md-12">
            <div class="card">
              <div class="card-header" style="background-color:#007cbc;color:white;margin-bottom:10px">
				  <h3 class="card-title"><b>Patient Discharge Search</b></h3>
				  <div class="card-tools">
                  <div class="input-group input-group-sm" style="width:120px;">
                   <a href="patientdis_entry.php"><button  name="add" id="add"  class="btn btn-default" style="color:#007cbc;font-weight:bold">+ ADD NEW</button></a>
                ...
                <table class="table table-bordered text-nowrap table-striped" id="example1">
                  <thead>
                    <tr>
												<th style="width:10px">Sr No</th>
                     						   	<th>Patient Name</th>
												<th>Disc.Date</th>
												<th>NURSING STAFF Name(Discharge)</th>
												<th>Room no</th>
                  ...
                  <tbody>
                     <?php 
							...
							$srno='0';
							$sql="select * from patientdis_entry order by `dt` desc";
                        ...
                        <td><?php $rcode=$row['roomno'];
													...
													echo $r2[0];
													?></td>
												<td style="color:black"><a href ="patientdis_entry.php?edit=<?php echo $row['code'];?>"><button class="btn btn-default btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Edit" style="margin-right:5px">
                                                            <i class="far fa-edit"></i>
									</button></a><a href="patientdis_input.php?delete=<?php echo $row['code'];?>"><button class="btn btn-default btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm('Are you sure you want to delete this entry ?')">
