      ...
      <div class="container-fluid">
          ...
          <div class="col-md-9">
            ...
            <div class="card">
              <div class="card-header" style="background-color:#007cbc;color:white">
				  <h3 class="card-title"><b>TREATMENT MASTER</b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="treatment_mst_input.php">
				  <?php
				
		$query = mysqli_query($con,"SELECT MAX(cast(code as decimal)) as code1 FROM treatment_mst");
		...
		$currentTime = date( 'Y-m-d', time ());
			...
			if(isset($_GET['edit'])){
					...
					//echo $code;
					$update= true;
					$qry="SELECT * FROM `treatment_mst` WHERE `code` = '$code'";
					//echo $qry;
			 ...
			 <div class="card-body">
					<div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">Treatment</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="treatment" name="treatment" class="form-control" style="width:100%" value="<?php if(isset($_GET['edit'])){echo $treatment;} ?>" autofocus required>
                                                </div>
                                            </div>
				 					
				 						<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">Rate</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                   <input type="text" name="rate" id="rate" class="form-control" value="<?php if(isset($_GET['edit'])){echo $rate;} ?>">
                                                </div>
                                            </div>
                <div class="row form-group">
                                                <div class="col col-md-3">
			 ...
			 <!-----footer----->
                  ...
                  <button type="submit" name="save" value="Save" class="btn btn-success float-right" style="margin-left:6px">Save</button>
									<?php } ?>
                  <a href="treatment_mst_report.php"><button type="button" class="btn btn-danger float-right">Back</button></a>
                </div>
