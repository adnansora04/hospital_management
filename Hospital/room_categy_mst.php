  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
		...
		$query = mysqli_query($con,"SELECT MAX(cast(code as decimal)) as code1 FROM room_categy_mst");
		...
		$currentTime = date( 'Y-m-d', time ());
			...
			if(isset($_GET['edit'])){
					...
					//echo $code;
					$update= true;
					$qry="SELECT * FROM `custmst` WHERE `code` = '$code'";
					//echo $qry;
			 ...
			 <div class="card-body">
					<div class="row form-group">
				 						...
				 						<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                   <input type="text" name="terrif" id="terrif" class="form-control" value="<?php if(isset($_GET['edit'])){echo $city;} ?>">
                                                </div>
                                            </div>
