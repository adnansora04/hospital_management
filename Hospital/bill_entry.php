				...
				<div class="container-fluid">
					<div class="row">
						...
						//echo $qry;
										...
										$q1=mysqli_query($con,"select diagnosis from diagnosis_mst where code='$diagnosis'");
										$ttl=$row['ttl'];
									...
									<div class="card-body">
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												...
												<select name="diagnosis" id="diagnosis" value="<?php if(isset($_GET['edit'])){echo $diagnosis;} ?>" class="form-control">
												<option value="">~~SELECT~~</option>
												<?php
												$qr1=mysqli_query($con,"select distinct code,diagnosis from  diagnosis_mst");
												while($row1=mysqli_fetch_array($qr1)){
													?>
													<option value="<?php echo $row1['code']; ?>"><?php echo $row1['diagnosis']; ?></option>
													<?php } ?>
											</select>
											</div>
										</div>
		...
		<div class="col-md-12">
			<div class="card-body">
				<div class="row form-group">
					...
					<div class="col-12 col-md-4">
						<select id="modefpay1" name="modefpay1"  class="select2" style="width:50%;">
					...
					<div class="col-12 col-md-2" >
						<input type="text" id="m1" name="m1" value="<?php if(isset($_GET['edit'])){echo $m1;} ?>" class="form-control" style="margin-left:-180;" >
					</div>

					<div class="col col-md -1" style="margin-left:50px">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-4">
						<select id="modefpay2" name="modefpay2"  class="select2" style="width:50%">
					...
					<div class="col-12 col-md-2">
						<input type="text" id="m2" name="m2" value="<?php if(isset($_GET['edit'])){echo $m2;} ?>" class="form-control" style="margin-left:-180;" >
					</div>
				</div>
			</div>
		</div>
