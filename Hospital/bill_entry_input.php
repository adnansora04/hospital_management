	...
	if($_POST['save']=="Save")
			  {
								...
								if (!$con)
								{
										...
										$m2=$_POST['m2'];
										$dcode=$_POST['dcode'];
								   		$qry="INSERT INTO `bill_entry`(`billno`, `dt`, `billtype`, `dtofadmiss`,`dtfdisc`, `pname`, `diagnosis`,`ttl`, `modefpay1`,`m1`, `modefpay2`,`m2`) VALUES ('$billno','$dt','$billtype','$dtofadmiss','$dtfdisc','$pname','$diagnosis','$ttl','$modefpay1','$m1','$modefpay2','$m2')";
