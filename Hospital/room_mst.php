      ...
      <div class="container-fluid">
          ...
          <div class="col-md-9">
            ...
            <div class="card">
              <div class="card-header" style="background-color:#007cbc;color:white">
				  <h3 class="card-title"><b>ROOM MASTER</b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="room_mst_input.php">
				  <?php
				
		$query = mysqli_query($con,"SELECT MAX(cast(code as decimal)) as code1 FROM room_mst");
		...
		$currentTime = date( 'Y-m-d', time ());
			...
			if(isset($_GET['edit'])){
					...
					//echo $code;
					$update= true;
					$qry="SELECT * FROM `room_mst` WHERE `code` = '$code'";
					//echo $qry;
						...
						//if(count($result==1)){
								...
								$row=mysqli_fetch_array($result);
									...
									$roomno=$row['roomno'];
                  					$catcode=$row['cat'];
									$q1=mysqli_query($con,"select cat from roomcatgry_mst where code='$catcode'");
			 ...
			 <div class="card-body">
					<div class="row form-group">
                                              ...
                                              <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                  <input type="text" id="roomno" name="roomno" class="form-control" style="width:100%" value="<?php if(isset($_GET['edit'])){echo $roomno;} ?>" autofocus required>
                                                   
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">Category</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                  <select id="categy" name="categy"  class="select2" style="width:100%;margin-left:25px">
													  <?php if($categy<>''){ ?><option value="<?php echo $catcode; ?>"><?php echo $categy; ?></option><?php } ?>
														<option value="">~~SELECT~~</option>
														<?php $sql2=mysqli_query($con,"select distinct code,cat from `roomcatgry_mst`");
                            ...
                            <?php if(isset($_GET['edit'])){?><option><?php echo $status; ?></option><?php } ?>
                            <option value="">~~SELECT~~</option>
                            <option>Ready</option>
			 ...
			 <!-----footer----->
                  ...
                  <button type="submit" name="save" value="Save" class="btn btn-success float-right" style="margin-left:6px">Save</button>
									<?php } ?>
                  <a href="room_mst_report.php"><button type="button" class="btn btn-danger float-right">Back</button></a>
                </div>
