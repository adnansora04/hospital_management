		...
		<div class="col-md-12">
            <div class="card">
              <div class="card-header" style="background-color:#007cbc;color:white;margin-bottom:10px">
				  <h3 class="card-title"><b>Room Transfer Search</b></h3>
				  <div class="card-tools">
                  <div class="input-group input-group-sm" style="width:120px;">
                   <a href="roomtransfer_entry.php"><button  name="add" id="add"  class="btn btn-default" style="color:#007cbc;font-weight:bold">+ ADD NEW</button></a>
                ...
                <table class="table table-bordered text-nowrap table-striped" id="example1">
                  ...
                  <tbody>
                     <?php 
							...
							$srno='0';
							$sql="select * from roomtransfer_entry";
						...
						{ 
							?>
										<tr style="color:black">
												...
												<td><?php echo $row['attedname']; ?></td>
												<td><?php $pcode=$row['pname'];
														$q2=mysqli_query($con,"select pname from patiant_mst where code='$pcode'");
														$r2=mysqli_fetch_array($q2);
														echo $pname=$r2[0]; ?></td>
                        						<td><?php $rcode=$row['curroomno'];
													$q2=mysqli_query($con,"select roomno from room_mst where code='$rcode'");
													$r2=mysqli_fetch_array($q2);
													echo $r2[0];
													?></td>

												<td style="color:black"><a href ="roomtransfer_entry.php?edit=<?php echo $row['code'];?>"><button class="btn btn-default btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Edit" style="margin-right:5px">
                                                            <i class="far fa-edit"></i>
									</button></a><a href="roomtransfer_input.php?delete=<?php echo $row['code'];?>"><button class="btn btn-default btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm('Are you sure you want to delete this entry ?')">
...
$("#roomtransferreport").addClass("active");
