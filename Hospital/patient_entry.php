...
<!----------SWEETALERT-->
  ...
  <div class="content-wrapper">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header" style="background-color:#007cbc;color:white">
				  <h3 class="card-title"><b>PATIENT ADMIT ENTRY</b></h3>
              </div>
			<!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="patiententry_input.php">
		  <?php
	...
	$room=$r1[0];
	$cat=$r1[1];
	$q2=mysqli_query($con,"select terrif from roomcatgry_mst where code='$cat'");
	$r2=mysqli_fetch_array($q2);
	$terrif=$r2[0];
	$query = mysqli_query($con,"SELECT MAX(cast(code as decimal)) as code1 FROM patient_entry");
    ...
    $code = $results['code1']+1;
		...
		if(isset($_GET['edit'])){
					...
					//echo $code;
					$update= true;
					$qry="SELECT * FROM `patient_entry` WHERE `code` = '$code'";
					//echo $qry;
          ...
          <div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="date" id="dt" name="dt"  class="form-control" value="<?php if((isset($_GET['edit']))||(isset($_GET['view']))){ echo $dt;} else{ echo $curdt;} ?>" <?php if(isset($_GET['edit'])){echo "readonly";} ?>>
												                      </div>
                                                <div class="col col-md-1">
                                                    <label for="hf-password" class=" form-control-label">Time</label>
                                                </div>
                                                <div class="col-12 col-md-4">
                                                    <input type="time" id="time" name="time"  class="form-control" value="<?php if((isset($_GET['edit']))||(isset($_GET['view']))){ echo $time;} else{ echo $ctime;} ?>" <?php if(isset($_GET['edit'])){echo "readonly";} ?>>
                                              </div>
				 ...
				 <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">Attendor Name</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                 <input type="text" id="attedname" name="attedname" value="<?php if((isset($_GET['edit']))||(isset($_GET['view']))){ echo $attedname;} else{ echo $username;} ?>" class="form-control" readonly="">
                 	...
                 	<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="roomno" name="roomno" value="<?php if((isset($_GET['edit']))||(isset($_GET['view']))){ echo $roomno;} else{ echo $room;} ?>" class="form-control" readonly>
				  ...
				  <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                   <input type="text" id="terrif" name="terrif"  class="form-control" value="<?php if(isset($_GET['edit'])){echo $terrif;}else{echo $terrif;} ?>" style="width:100%" readonly>
					  							</div>
                                            </div>
                       <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-10 col-md-9">
                                                  <select class="select2" id="pname" name="pname" style="width:100%">
													<?php if(isset($_GET['edit'])){?><option value="<?php echo $pcode; ?>"><?php echo $pname; ?></option><?php } ?>
													  <option value="">~~SELECT~~</option>
													  <!--<option>ADD NEW</option>-->
													<?php
													$qr1=mysqli_query($con,"select distinct code,pname from patiant_mst");
													while($res1=mysqli_fetch_array($qr1)){?>
													<option value="<?php echo $res1['code']; ?>"><?php echo $res1['pname']; ?></option>
														<?php } ?>
													 </select>
												</div>
                        <!--<div class="col-2 col-md-2">
                        <a href="patient_mst.php" target="_blank">
                        <label name="add" value="Add"  class="btn btn-primary float-right" style="margin-right:30px; width:125px;">
											Add 
                        </label>
                        </a>
                       </div>-->
				 						...
				 						<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                  <input type="text" name="mob" id="mob" value="<?php if(isset($_GET['edit'])){echo $mob;} ?>" class="form-control">  
												</div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                  <input type="text" name="city" id="city" value="<?php if(isset($_GET['edit'])){echo $city;} ?>" class="form-control">  
												</div>
                                            </div>                     
				  
							<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">Deposit Amt</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                  <input type="text" name="depamt" id="depamt" value="<?php if(isset($_GET['edit'])){echo $depamt;} ?>" class="form-control">  
												</div>
                                            </div>
				 		<div class="row form-group">
                                                <div class="col col-md-3">
			 ...
			 <!-----footer----->
				...
				<button type="submit" name="save" value="Save" class="btn btn-success float-right" style="margin-left:6px">Save</button>
                 <?php } ?>
                  <a href="patient_entry_report.php"><button type="button" class="btn btn-danger float-right">Back</button></a>
                </div>
...
<script>
	$('#pname').select2().on('change', function(){
		var pcode=$('#pname').val();
		if(pcode=="ADD NEW"){
		//alert("add new");
		window.open("http://mksoftservice.com/Killolhospital/patient_mst.php","blank");
		$('#flag').val('true');
		}
		else{
				$.ajax({
				url: 'getpatientdtl.php',
				type: 'post',
				data: {pcode : pcode},
				dataType: 'json',
				success:function(response) {
