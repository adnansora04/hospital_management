		...
		<div class="col-md-12">
            <div class="card">
              <div class="card-header" style="background-color:#007cbc;color:white;margin-bottom:10px">
				  <h3 class="card-title"><b>Room Master Search</b></h3>
				  <div class="card-tools">
                  <div class="input-group input-group-sm" style="width:120px;">
                   <a href="room_mst.php"><button  name="add" id="add"  class="btn btn-default" style="color:#007cbc;font-weight:bold">+ ADD NEW</button></a>
                ...
                <table class="table table-bordered text-nowrap table-striped" id="example1">
                  ...
                  <tbody>
                     <?php 
							...
							$srno='0';
							$sql="select * from room_mst order by 1=1";
						...
						{ 
							?>
										<tr style="color:black">
												...
												<td><?php $catcode=$row['cat'];
													$q1=mysqli_query($con,"select cat from roomcatgry_mst where code='$catcode'");
													$r1=mysqli_fetch_array($q1);
													echo $r1[0];
													?></td>
												<td style="color:black"><a href ="room_mst.php?edit=<?php echo $row['code'];?>"><button class="btn btn-default btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Edit" style="margin-right:5px">
                                                            <i class="far fa-edit"></i>
									</button></a><a href="room_mst_input.php?delete=<?php echo $row['code'];?>"><button class="btn btn-default btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm('Are you sure you want to delete this entry ?')">
